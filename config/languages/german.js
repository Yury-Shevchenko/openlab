module.exports = {
  layout: {
    ...
    flash_program_closed:
      'Die Studie wird für nicht eingeladene Teilnehmer unsichtbar gemacht.',
    flash_program_run: 'Diese Studie läuft und nimmt neue Teilnehmer an.',
    flash_program_archive:
      'Diese Studie läuft nicht und nimmt keine neuen Teilnehmer an.',
    ...
    flash_email_confirmed: 'Ihre E-Mail Adresse wurde bestätigt!',
  },
  ...
  passport: {
    ...
    signed_up:
      'Sie sind angemeldet. Wir haben eine E-Mail mit einem Bestätigungslink an Ihre E-Mail-Adresse gesendet. Um den Anmeldevorgang abzuschließen, klicken Sie bitte auf den Bestätigungslink.',
  },
  ...
  index: {
    ...
    intro:
      'Der Zweck von Open Lab ist es, Online-Experimente einfach, transparent und sicher durchzuführen. ' +
      'Es ist für Forscher gedacht, die ihre Studie im Internet erstellen und durchführen möchten. ' +
      'Open Lab ist integriert mit dem ' +
      '<a target="_blank" href="https://labjs.felixhenninger.com/">lab.js experiment builder</a>' +
      ', mit dem Sie Ihre eigene Studie erstellen können. ' +
    ...
    announcement:
      'Wir freuen uns sehr und sind stolz darauf, die Integration von Open Lab mit ' +
    ...
    res_1_text:
      'Es ist nicht nötig, einen eigenen Server einzurichten. Verwenden Sie vorhandene Vorlagen oder laden Sie mit einem Klick eine Studie aus lab.js hoch.',
  ...
  projects: {
    ...
    confirmMessage_2:
      ' im Textfeld unten ein, um zu bestätigen, dass Sie die Studie löschen möchten. ',
    confirmMessage_3: 'Alle Ergebnisse dieser Studie werden gelöscht.',
    confirmMessage_4: ' Diese Aktion ist nicht umkehrbar.',
    delete: 'Löschen',
    description: 'Beschreibung',
    showCompletionCode:
      'Erstellen und zeigen den Teilnehmern einen individuellen Code, wenn alle Aufgaben erledigt sind.',
    welcomeMessage: 'Nachricht an die Teilnehmer vor Abschluss der Aufgaben',
    completionMessage:
      'Nachricht an die Teilnehmer nach Abschluss der Aufgaben',
    askNotifications:
    ...
    allowMultipleParticipation:
      'Erlauben den Teilnehmern eine mehrfache Teilnahme am gleichen Test.',
    enterExternalUrl: `
  ...
  constructor: {
    ...
    no_project_message:
      'Um IIhrer Studie Aufgaben hinzuzufügen, erstellen oder aktivieren Sie ' +
      '<a href="/projects">hier</a>' +
      ' eine Studie.',
    randomization_header: 'Aufgaben randomisieren',
    randomize_order_header:
      'Sollte die Reihenfolge der Aufgaben für jeden Teilnehmer randomisiert werden?',
    randomize_yes: 'Ja',
    randomize_no: 'Nein',
    sample_header:
      'Geben Sie die Anzahl der Aufgaben für einen Teilnehmer ein. Lassen Sie das Feld leer, wenn die Teilnehmer an allen Aufgaben teilnehmen sollen.',
  ...
  tasks: {
    ...
    subtitle_no_customized_2:
      'Im Folgenden finden Sie die Anfangsparameter für diesen Test. Sie können sie bearbeiten und als Ihre eigenen Parameter speichern. Beachten Sie, dass die Parameter für die gewählte Sprache gespeichert werden. Nach dem Speichern wird die Aufgabe mit Ihren Parametern ausgeführt.',
    ...
    create_your_project:
      'Erstellen oder aktivieren Sie Ihre Studie <a href="/projects">hier</a>.',
    results_download_test_results:
      'Alle Ergebnisse für diesen Test herunterladen',
    language: 'Sprache',
    ...
    delete: 'Löschen',
    task_has_parameters:
      'Die Aufgabe hat vordefinierte Parameter, die vom Autor festgelegt wurden.',
  ...
  tests: {
    ...
    edit_public_description:
      'Stellen Sie Ihren Test anderen Forschern und Teilnehmern zur Verfügung',
    edit_private: 'Privat',
    edit_private_description:
      'Stellen Sie Ihren Test nur Ihnen und Ihren Teilnehmern zur Verfügung',
    edit_save: 'Speichern',
    test_card_run: 'Den Task starten',
    test_card_download: 'JSON herunterladen',
    test_card_open: 'Öffnen im lab.js builder',
    test_card_open_beta: 'Öffnen im lab.js builder (beta)',
    upgradeNeededMessage:
      'Bitte  <a target="_blank" href="/subscribe")>erweitern</a> Sie Ihr Abonnement, um Ihre Tests privat zu machen.',
    ...
    confirmMessage_2:
      ' in das leere Textfeld unten ein, um zu bestätigen, dass Sie den Test löschen möchten. Diese Aktion ist nicht umkehrbar. Bitte beachten Sie, dass das Löschen der Aufgabe auf die Studien auswirkt, die sie verwenden.',
    delete: 'Löschen',
  ...
  results: {
    ...
    result_delete_confirm:
      'Sind Sie sicher, dass Sie alle Einträge löschen wollen?',
    result_full: 'Komplett',
    result_incremental: 'Inkremental',
    results_rows: 'Zeilen',
  ...
  data: {
    ...
    testNotFound:
      'Der Test wurde nicht gefunden. Vielleicht wurde sie gelöscht oder ersetzt.',
    ...
    subtitle_no_customized_1: 'Keine eigenen Parameter angegeben für ',
    subtitle_no_customized_2:
      'Sie können die eigenen Parameter bearbeiten und speichern. Nach dem Speichern wird die Aufgabe mit Ihren Parametern ausgeführt.',
    subtitle_customized: 'Eigene Parameter für ',
    save: 'Speichern',
  ...
  invitations: {
    ...
    signing_email: 'Anmeldung mit einer E-Mail ',
    message_create_project:
      'Um neue Teilnehmer zu Ihrer Studie einzuladen, aktivieren oder erstellen Sie eine Studie <a href="/projects")>hier</a>.',
    ...
    temp_code_strategy: `
        ...
        `,
    code_strategy:
      'Die Teilnehmer werden aufgefordert, sich mit der Eingabe eines Teilnahmecodes anzumelden. Verwenden Sie diese Art der Authentifizierung, wenn Ihre Teilnehmer bereits über ihre individuellen Codes verfügen, die von Ihrer Studie vergeben wurden.',
    email_strategy: `
  ...
  subscribe: {
    ...
    stoppedSubscription:
      'Ihr Abonnement wurde gekündigt, aber Sie können den Dienst nutzen, bis ',
  ...
  docs: {
    ...
    introduction_1:
      'Willkommen bei Open Lab, einer Plattform für Online-Experimente! ',
    introduction_2:
  ...
  help: {
    ...
    type_in_your_email:
      'Geben Sie Ihre E-Mail-Adresse ein, damit wir Ihnen antworten können.',
  },
  ...
  notifications: {
    ...
    testing_message:
      'Die Teilnehmer sollten ein Android-Telefon oder Google Chrome auf Desktops verwenden, um Benachrichtigungen zu aktivieren und zu erhalten.',
    title: 'Titel',
    ...
    schedule_explanation_1:
      'Die Zeitplanart der Benachrichtigungen wird für einmalige Benachrichtigungen verwendet, die an alle Teilnehmer Ihrer Studie gesendet werden.',
    schedule_explanation_2:
      'Wählen Sie das Datum und die Uhrzeit für die zu sendende(n) Benachrichtigung(en). Sie können weitere Zeitpunkte eintragen, wenn Sie möchten.',
    add: 'Hinzufügen',
    interval_explanation_1:
      'Die Intervallbenachrichtigung wird für regelmäßige Benachrichtigungen verwendet, die an alle Teilnehmer Ihrer Studie gesendet werden.',
    interval_explanation_2:
      'Wählen Sie den Zeitraum und das Intervall für regelmäßige Benachrichtigungen. Beispielsweise erzeugt das Intervall "0 15 * * Sat" eine Benachrichtigung, die jeden Samstag um 15:00 Uhr an jeden Benutzer gesendet wird.',
    cron_explanation:
      'Das Intervall wird in einem Cron-Format angegeben. Die Beschreibung und Beispiele sind <a target="_blank" href="https://crontab.guru/">hier</a>.',
    minute: 'Minute',
    hour: 'Stunde',
    day_month: 'Tag (Monat)',
    month: 'Monat',
    day_week: 'Tag (Woche)',
    individual_explanation_1:
      'Die einzelnen Benachrichtigungen hängen davon ab, wann ein Teilnehmer Benachrichtigungen aus Ihrer Studie genehmigt hat.',
    individual_explanation_2:
      'Wählen Sie den Zeitraum und das Intervall für Benachrichtigungen aus. Beispielsweise erzeugt eine 7-tägige Dauer mit dem Intervall "0 12 * * *" eine Benachrichtigung, die jeden Tag um 12:00 Uhr für eine Woche an einen neuen Benutzer gesendet wird.',
  ...
  osf: {
    ...
    announcement:
      ...
      'Das bedeutet, dass Sie eine unbegrenzte Anzahl von Teilnehmern haben können, wenn Sie Ihre Daten im OSF speichern. ',
    announcement_errors:
      'Wenn Sie Fehler bemerken, lassen Sie es uns bitte über unser ' +
    ...
    recording_1_desc:
      'Speichern Sie die Daten auf OSF + speichern Sie die Daten in Open Lab',
    recording_2: 'OSF',
    recording_2_desc:
      'Speichern Sie die Daten nur auf OSF und nicht in Open Lab',
    recording_3: 'Open Lab',
    recording_3_desc:
      'Speichern Sie die Daten in Open Lab und senden Sie die Daten nicht an OSF',
    ...
    token_explained:
      'Wir benötigen Ihren OSF-Token, um Daten in das neue oder bereits bestehende OSF Projekt schreiben zu können. ' +
      'Wir werden diesen Token sicher aufbewahren und nur zur Speicherung der Daten der Studienteilnehmer verwenden. ',
    token_explained_2:
      '. Sie können das Token später löschen, wenn Sie sich entscheiden, die Verbindung zwischen dem Open Lab und dem OSF-Projekt zu entfernen. ',
    token_explained_3:
      'Lesen Sie mehr über ' +
    ...
    no_studies_yet:
      'Bitte erstellen oder aktivieren Sie zuerst eine Open Lab Studie <a href="/projects">hier</a>.',
